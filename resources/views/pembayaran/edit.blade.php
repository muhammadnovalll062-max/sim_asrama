...
@section('content')
<div class="page-title">Edit Pembayaran</div>
<div class="card">
    <form method="POST" action="{{ route('pembayaran.update', $pembayaran->id_pembayaran) }}">
        ...
        <div class="form-group">
            ...
            <select name="id_penghuni">
                ...
                <option value="{{ $p->id_penghuni }}" {{ old('id_penghuni',$pembayaran->id_penghuni)==$p->id_penghuni ? 'selected':'' }}>
        ...
        <div class="form-group">
            ...
            <input type="text" name="bulan_bayar" value="{{ old('bulan_bayar', $pembayaran->bulan_bayar) }}">
        </div>
        <div class="form-group">
            <label>Jumlah (Rp)</label>
            <input type="number" name="jumlah" value="{{ old('jumlah', $pembayaran->jumlah) }}" min="0">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="keterangan" value="{{ old('keterangan', $pembayaran->keterangan) }}">
        </div>
